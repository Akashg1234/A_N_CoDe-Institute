...
include 'connect.php';
session_start();
$stuid=$_SESSION['admin_pass_up_id'];
$q2=" SELECT adminname,phone FROM adminreg WHERE adminid='$stuid' ";
...
if(isset($_POST['subbtn']))
{
   ...
   $q=" UPDATE adminreg SET passw='$hashedpass' WHERE adminid='$stuid' ";
...
<body>
   ...
   <div style=" margin-top: 30px;">
      <a href="new-adminpasswordupdate.php" class="p-2" 
      style="
      margin-left: 575px;
      font-size:30px; 
      color: grey; 
