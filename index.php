...
<nav class="navbar bg-dark navbar-expand-lg navbar-dark" id="navbarNav">
		<ul class="navbar-nav" style="list-style: none;">
			<li class="nav-item" style="font-size:18px;">
				<a href="#" class=" nav-link text-white font-weight-bold" style="margin-left:  0px; font-size:18px;">Home </a>
			</li>
			<li class="nav-item">
			...
			<li class="nav-item">
				<a href="notice.php" class=" nav-link text-white" style="margin-left:  15px; font-size:18px;"> Notice </a>
			</li>
			<li class="nav-item">
	...
	<center>
      ...
      margin-top: 100px;
      margin-bottom: 100px;
      text-shadow: 0px 0px 80px gold,0px 0px 100px gold,0px 0px 150px gold,0px 0px 200px gold;">
         A_N_CoDe
      </div>
      <div class="a" style="
      ...
      text-shadow: 0px 0px 5px white;">
         Everybody should know how to program a computer,<br>
