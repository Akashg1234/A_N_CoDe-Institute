...
<html>
<head>
   <title>Instructor registration desk</title>
...
<style type="text/css">
   a{text-decoration: none;}a:hover{text-decoration: none;}label{font-weight: bold;font-size: 20px;float: left;}
#REGISTER
{
   top: 100px;
...
<body>
         ...
         <li class="nav-item">
            <div class="dropdown">
               ...
               <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                ...
                <a href="#" class="btn dropdown-item font-weight-bold" type="button">Instructor</a>
   ...
   <center>
      ...
      <div class="text-center text-white w-100 bg-dark rounded-top" style="height: 40px;">
         <h3 class="">Instructor Registreation Form</h3>
      </div><br><br>
      <form method="post" action="" class="form pt-5 pl-5 pb-5 pr-5 w-100" id="formValidation" >
         ...
         <label>Domain:</label>
            <select class="form-control w-100 text-center" required="" onchange="" name="course">
               <option selected="" disabled="">--Select--</option>
               <?php
...
<?php
   ...
   if (isset($_POST['subbtn'])) 
   {
     ...
     if($pass1==$pass2)
     {
      ...
      $q2=" INSERT INTO  staff ( staffid ,  stafftype ,  name ,  phone ,  email ,  conpass ,  dob ,  quali ,  gender ,  expe ,  domain ,  dom_id ,  passins ,  passyer ,  passper ,  previns ,  adharno ,  panno ,  dateofjoin ,  salary ,  status ) VALUES('$id','Instructor','$name','$phone','$email','$newPass','$dob','$quali','$gen','$experience','$domain','$domainid[0]','$passins','$passyr','$passper','$previns','$adharno','$panno','$doj','$salary','Active') ";
      if(mysqli_query($connect,$q2))
      {
         
         SendMessage($name,$phone,$id,$pass2,$course,$coursinst);
         echo "<script>alert('Successfully added...');
                     window.location.href='instructor-register.php';
                     </script>";
      }
      else
