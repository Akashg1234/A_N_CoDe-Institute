		...
		<tr>
			...
			<td class="text-center">
				...
				<button class="btn btn-success ">
					<a href="updateinstructor.php?
					id=<?php echo getName();
					$_SESSION['updateid']=$val[0]; ?>&name=<?php echo getName();
					$_SESSION['name']=$val[2]; ?>&phone=<?php echo getName();
					$_SESSION['phone']=$val[3]; ?>&email=<?php echo getName();
