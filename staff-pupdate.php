...
include 'connect.php';
session_start();
$stuid=$_SESSION['staff_pass_up_id'];
$q2=" SELECT name,phone FROM staff WHERE staffid='$stuid' ";
...
if(isset($_POST['subbtn']))
{
   ...
   $q=" UPDATE staff SET conpass='$hashedpass' WHERE staffid='$stuid' ";
   if(mysqli_query($connect,$q))
   {
      ...
      if($_SESSION['stafftype']=='Instructor')
         ...
         window.location.href = 'instructor-view.php'
         </script>";
...
<body>
   ...
   <div style=" margin-top: 30px;">
      <a href="staffpasswordupdate.php" class="p-2" 
      style="
      margin-left: 575px;
      font-size:30px; 
      color: grey; 
