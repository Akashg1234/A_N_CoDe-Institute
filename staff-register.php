...
<html>
<head>
   <title>Staff registration desk</title>
...
<body>
   ...
   <center>
      ...
      <div class="text-center text-white w-100 bg-dark rounded-top" style="height: 40px;">
         <h3 class="">Staff Registreation Form</h3>
      </div><br><br>
...
<?php
   ...
   if (isset($_POST['subbtn'])) 
   {
     ...
     if($pass1==$pass2)
     {
      ...
      $q2=" INSERT INTO  staff ( staffid ,  stafftype ,  name ,  phone ,  email ,  conpass ,  dob ,  quali ,  gender ,  expe ,  passins ,  passyer ,  passper ,  previns ,  adharno ,  panno ,  dateofjoin ,  salary ,  status ) VALUES('$id','Normal Staff','$name','$phone','$email','$newPass','$dob','$quali','$gen','$experience','$passins','$passyr','$passper','$previns','$adharno','$panno','$doj','$salary','Active') ";
      if(mysqli_query($connect,$q2))
      {
         echo "<script>alert('Successfully inserted...');</script>";
         SendMessage($name,$phone,$id,$pass2,$course,$coursinst);
         echo "<script>window.location.href='staff-register.php';</script>";
